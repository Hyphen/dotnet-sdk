...
To report a security vulnerability, please post an issue in our repository for [@hyphen/sdk](https://github.com/hyphen/dotnet-sdk/issues) and mark it with `security vulnerability`. You need to add in the issue description the following information:
